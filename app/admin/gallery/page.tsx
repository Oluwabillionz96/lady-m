  ...
  if (!result.success) {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-bold text-luxury-text">Gallery Management</h1>
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-luxury-text-muted mt-1">
            Manage your portfolio photos ({result.data.length} photos)
          </p>
        </div>
      ...
      {result.data.length > 0 ? (
        ...
        <div className="text-center py-12">
          <div className="bg-luxury-light rounded-lg p-8 border border-luxury-accent/20">
            ...
            <h3 className="text-lg font-medium text-luxury-text mb-2">No photos yet</h3>
